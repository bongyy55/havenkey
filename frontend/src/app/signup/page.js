...
export default function ClientSignup() {
  ...
  const [initialX] = useState(() => {
    ...
    return sessionStorage.getItem("authNavDir") === "toClient" ? -48 : 0;
  });
  ...
  const goToAgent = (e) => {
    e.preventDefault();
    sessionStorage.setItem("authNavDir", "toAgent");
    setExitX(-48);
    setTimeout(() => router.push("/signup/agent"), 220);
  };
              ...
              <div className="group">
                ...
                <div className="relative flex items-center">
                  ...
                  <button
                    ...
                    className="absolute right-3 text-[11px] font-semibold text-[#2B2B2B]/50 hover:text-[#C9975C] cursor-pointer transition-colors px-2 py-1"
                  >
