              ...
              <div className="relative">
                ...
                <div className="flex border border-[#111111]/15 rounded-xl bg-white hover:border-[#111111]/30 focus-within:border-[#C9975C] focus-within:ring-2 focus-within:ring-[#C9975C]/20 transition-all duration-300">
                  ...
                  <div className="relative flex items-center w-full">
                    <span className="absolute left-3 z-10 text-[#2B2B2B]/40 transition-colors pointer-events-none">
                    ...
                    <input
                      ...
                      value={form.phone}
                      onChange={handleChange}
                      className="w-full pl-9 pr-3 py-2.5 text-sm text-[#111111] outline-none bg-transparent"
